    ...
    describe("copy", () => {
        ...
        describe("two characters before new line", () => {
            test.each([
                ...
                chars.map((c) =>
                    expect(destination.writeChar).toHaveBeenCalledWith(c)
                );
            });
        });
        ...
        describe("characters after new line are not written", () => {
            test.each([
                ...
                ({ chars: chars, result: expected }) => {
                    ...
                    expect(destination.getWrittenChars()).toStrictEqual(
                        expected
                    );
                }
            );
